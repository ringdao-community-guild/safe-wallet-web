...
This document explains how analytics are implemented in the DSafe mobile app using Firebase Analytics, designed to match the Google Analytics implementation in the web app.
