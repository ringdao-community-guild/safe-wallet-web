...
This document explains how push notifications are implemented in the DSafe mobile app. It covers the subscription flow, how notifications are displayed, and differences between iOS and Android.
